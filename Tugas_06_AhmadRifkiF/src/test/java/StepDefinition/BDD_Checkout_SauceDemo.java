...
public class BDD_Checkout_SauceDemo<WebElement> {
	...
	public void user_open_browser() {
		...
		//chromedriver setup
		System.setProperty("webdriver.chrome.driver", "C:/Users/rifki/eclipse-workspace/Tugas_06_AhmadRifkiF/src/test/resources/drivers/chromedriver.exe");
    ...
    public void the_user_provides_their_first_name_last_name_and_ZIP_postal_code() {
        ...
        ((org.openqa.selenium.WebElement) firstNameInput).sendKeys("Ahmad");
        ((org.openqa.selenium.WebElement) lastNameInput).sendKeys("Rifki");
